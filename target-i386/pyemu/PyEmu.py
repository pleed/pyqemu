    ...
    def get_register(self, register):
        ...
        # Check to make sure the user isnt requesting by name
            ...
            if register in self.register_names:
                ...
                print "[!] Couldnt determine register: %s"%register
                return False
...
''' 
class PEPyEmu(PyEmu):
    def __init__(self, stack_base=0x0095f000, stack_size=0x1000, heap_base=0x000a0000, heap_size=0x2000, frame_pointer=True, membackend = None):
        ...
        self.memory = PEMemory(self, membackend)
