...
DEF_HELPER_4(flx_memtrace_read,  void, i64, i64, i64, i64)
DEF_HELPER_4(flx_memtrace_write, void, i64, i64, i64, i64)
...
DEF_HELPER_2(flx_jmp, void, tl, tl)
DEF_HELPER_3(flx_call, void, tl, tl, tl) 
DEF_HELPER_1(flx_ret, void, tl)
