...
static void gen_helper_fp_arith_ST0_FT0(int op)
{
    ...
    case 1: gen_helper_fmul_ST0_FT0();
	    ...
	    break;
    case 2: gen_helper_fcom_ST0_FT0();
    		FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_OTHER));
	    break;
    case 3: gen_helper_fcom_ST0_FT0();
    		FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_OTHER));
	    break;
    case 4: gen_helper_fsub_ST0_FT0();
    		FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_OTHER));
	    break;
    case 5: gen_helper_fsubr_ST0_FT0();
    		FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_OTHER));
	    break;
    case 6: gen_helper_fdiv_ST0_FT0();
    		FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_DIV));
	    break;
    case 7: gen_helper_fdivr_ST0_FT0();
    		FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_DIV));
	   break;
    }
}
...
static void gen_helper_fp_arith_STN_ST0(int op, int opreg)
{
    ...
    case 1: gen_helper_fmul_STN_ST0(tmp);
		FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_MUL));
		break;
    case 4: gen_helper_fsubr_STN_ST0(tmp);
		FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_OTHER));
		break;
    case 5: gen_helper_fsub_STN_ST0(tmp);
		FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_OTHER));
		break;
    case 6: gen_helper_fdivr_STN_ST0(tmp);
		FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_DIV));
		break;
    case 7: gen_helper_fdiv_STN_ST0(tmp);
		FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_DIV));
		break;
    }
}

void flx_memtrace_read(TCGv ret, TCGv addr, uint8_t size){
	if(flx_state.global_active &&\
	   ...
	   flx_filter_search_by_addr(current_environment->eip))
		gen_helper_flx_memtrace_read(ret, addr, tcg_const_i32(size));
}
...
static void gen_op(DisasContext *s1, int op, int ot, int d, target_ulong pc_start)
{
    ...
    default:
    case OP_ANDL:
        FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_AND));
        ...
        break;
    case OP_ORL:
        FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_OR));
        ...
        break;
    case OP_XORL:
        FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_XOR));
                           ...
                           int is_right)
{
    ...
    FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_ROX));
    if (is_right) {
        switch (ot) {
...
static void gen_shift(DisasContext *s1, int op, int ot, int d, int s, target_ulong pc_start)
{
    ...
    case OP_ROR:
        ...
        break;
    case OP_SHL:
        FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_SHX));
...
static void gen_flx_bblstart(target_ulong cur_eip, DisasContext* s){
    flx_hook(FLX_ON_FILTERED | FLX_ON_BBLTRACE , s, gen_helper_flx_bblstart, tcg_const_i32(cur_eip));
}
...
static target_ulong disas_insn(DisasContext *s, target_ulong pc_start)
{
 ...
 reswitch:
    ...
    case 0x88:
    case 0x89: /* mov Gv, Ev */
	FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_MOV));
        if ((b & 1) == 0)
            ot = OT_BYTE;
        else
            ot = dflag + OT_WORD;
    ...
    case 0x1ba: /* bt/bts/btr/btc Gv, im */
        FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_BIT));
        ot = dflag + OT_WORD;
        modrm = ldub_code(s->pc++);
        op = (modrm >> 3) & 7;
        mod = (modrm >> 6) & 3;
                                                  ...
                                                  int search_pc)
{
    ...
    for(;;) {
        ...
        num_insns++;
        FLX_BBLTRANSLATE_HOOK(flx_bbltranslate_insn(INSN_COUNTER));
