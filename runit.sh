...
#/usr/local/bin/qemu -hda /home/felix/Projects/lehrstuhl_bonn/winxp_network.img -m 1024 -net user -net nic,model=pcnet -loadvm ssh
#/usr/local/bin/qemu -hda /home/felix/Projects/lehrstuhl_bonn/winxp_network.img -m 1024 -net user -net nic,model=pcnet -loadvm md5deep
/usr/local/bin/qemu -hda /home/felix/Projects/lehrstuhl_bonn/winxp_network.img -m 1024 -net user -net nic,model=pcnet -loadvm restored
